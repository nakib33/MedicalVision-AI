"""Download RetinaVision AI - Retinal Disease Classification dataset from Kaggle."""
...
CLASSES = ["Normal", "Diabetic Retinopathy", "Glaucoma", "Cataract", "Age-related Macular Degeneration", "Hypertensive Retinopathy", "Myopia", "Other"]
...
def download():
    print("=" * 60)
    print("RetinaVision AI - Retinal Disease Classification Dataset Downloader")
    print("=" * 60)
    if DATA_DIR.exists():
