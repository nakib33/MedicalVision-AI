"""Download GastroVision AI - GI Tract Disease Classification dataset from Kaggle."""
...
CLASSES = ["Esophagitis", "Polyps", "Ulcerative Colitis", "Dyed Lifted Polyps", "Dyed Resection Margins", "Cecum", "Pylorus", "Z-Line"]
...
def download():
    print("=" * 60)
    print("GastroVision AI - GI Tract Disease Classification Dataset Downloader")
    print("=" * 60)
    if DATA_DIR.exists():
